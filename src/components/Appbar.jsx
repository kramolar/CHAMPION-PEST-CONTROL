      ...
      <div className="bg-black-shade flex items-center justify-between md:p-4  fixed top-0 w-full z-50">
        ...
        <div className="flex items-center">
          ...
          <div
            ...
            } text-md md:text-2xl font-normal font-abel ml-10`}
          >
          ...
          <div
            className={`text-letter-color hover:underline ${
              isServices ? "underline" : ""
            } text-md md:text-2xl font-normal font-abel ml-6 md:ml-10`}
          >
          ...
          <div
            ...
            } text-md md:text-2xl font-normal font-abel ml-6 md:ml-10 mr-4`}
          >
