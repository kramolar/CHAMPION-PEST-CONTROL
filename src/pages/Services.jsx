    ...
    <div className="pt-8 mx-10 divide-y-4 divide-brown-shade">
      <div className="flex flex-col md:flex-row mb-12">
        ...
        <div className="flex-1 mt-8 md:mt-0 md:mx-8">
          ...
          <ul className="mt-2 list-disc list-inside">
            ...
            <li>
              Retail Stores: Protecting your inventory and providing a pleasant
            ...
            <li>
              Healthcare Facilities: Maintaining a sanitary space essential for
              patient safety and care.
            </li>
            <li>
              Hotels and Hospitality: Ensuring a comfortable and pest-free stay
              for your guests.
            </li>
          </ul>
        </div>
      ...
      <div className="flex flex-col md:flex-row mb-12 pt-12">
        ...
        <div className="flex-1 mt-8 md:mt-0 md:mx-8">
          ...
          <ul className="mt-2 list-disc list-inside">
            ...
            <li>
              Food Processing Facilities: Maintaining compliance with health and
              safety regulations.
            </li>
            <li>
      ...
      <div className="flex flex-col md:flex-row pt-12">
        ...
        <div className="flex-1 mt-8 md:mt-0 md:mx-8">
          ...
          <ul className="mt-2 list-disc list-inside">
            <li>
              Ant Control: Effective solutions to eliminate ant infestations and
            ...
            <li>
              Spider Control: Removing and preventing spiders from invading your
              living spaces.
            </li>
            <li>
